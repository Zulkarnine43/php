...
$sql = "INSERT INTO addcategory (categoryName,categoryDescription,longDescription,status) VALUES ('$data[categoryName]','$data[categoryDescription]','$data[longDescription]','$data[status]')";
