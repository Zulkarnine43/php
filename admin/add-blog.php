...
$sql = "INSERT INTO addblog (blogName,blogDescription,longDescription,status) VALUES ('$data[categoryName]','$data[categoryDescription]','$data[longDescription]','$data[status]')";
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group row">
                            <label for="Name" class="col-sm-3 col-form-label">Blog Name</label>
                            <div class="col-sm-9">
                                <input type="text" name="categoryName" class="form-control" id="Name" placeholder="Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Description" class="col-sm-3 col-form-label">Blog Description</label>
                            <div class="col-sm-9">
                                <input type="text" name="categoryDescription" class="form-control" id="Description" placeholder="Category Description">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-3 col-form-label">Blog Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control textarea"  name="longDescription" rows="5" cols="40"></textarea>
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" name="btn" class="btn btn-success btn-block" value="submit">Save Blog Info</button>
                            </div>
                        </div>
                    </form>
