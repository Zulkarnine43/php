        ...
        <div class="col-sm-6 mx-auto">
            ...
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <td><?php  echo $manage['categoryName'];   ?></td>
                    <td><?php  echo $manage['categoryDescription'];   ?></td>
                     ...
                     <td><?php  echo $manage['status'];   ?></td>
                      ...
                      <td>
                          ...
                          <a href="manage-category.php?delete=<?php  echo  $manage['id'];   ?>">delete</a>
                          <a href="edit-category.php?edit=<?php echo $manage['id']; ?>">edit</a>
                          <a href="update-category.php?update=<?php echo $manage['id']; ?>">update</a>
