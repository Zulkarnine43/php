            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="categoryName" class="form-control" value="<?php $name;  ?>" id="Name" placeholder="Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Description" class="col-sm-3 col-form-label">Category Description</label>
                            <div class="col-sm-9">
                                <input type="text" name="categoryDescription" class="form-control"  value="<?php $Description;  ?> " id="Description" placeholder="Category Description">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-3 col-form-label">Long Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control textarea"   name="longDescription" value="<?php $long;  ?>" rows="5" cols="40"></textarea>
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" name="btn" class="btn btn-success btn-block" value="submit">edit Category Info</button>
                            </div>
